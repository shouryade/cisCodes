...
exports.getQuestion = catchAsync(async (req, res, next) => {
	...
	if (req.user.level + 1 >= (await getTotalQuestions())) {
		return res.status(200).json({
			status: "success",
			message: "Congratulations, you have completed Cache Quest 3.0!!",
		});
	}
...
//WIP
	// const checked1 = await question.compareAnswer(req.body.answer, question.answer);

	// if (!checked1) {
	// 	console.log(checked1);
	// 	throw new AppError("Wrong answer. Please try again!", 404);
	// }
